...
namespace Telemetri.Variables
{
    public static class DataVCU
    {
        ...
        public static byte TCU_seconds_u8;
        ...
        public static bool EMS_Wake_u1     => Convert.ToBoolean((drive_commands_u8 >> 7 & 0b00000001));

        public static bool bms_can_error_u1 => Convert.ToBoolean((can_error_u8 >> 0 & 0b00000001));
        public static bool mcu_can_error_u1 => Convert.ToBoolean((can_error_u8 >> 1 & 0b00000001));
        public static bool vcu_can_error_u1 => Convert.ToBoolean((can_error_u8 >> 2 & 0b00000001));
        public static bool ems_can_error_u1 => Convert.ToBoolean((can_error_u8 >> 3 & 0b00000001));
        /*
         * Brake
         * 0: Off
         * 1: On
