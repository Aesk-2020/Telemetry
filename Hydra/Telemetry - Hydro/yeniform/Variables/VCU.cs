...
namespace telemetry_hydro.Variables
{
    public struct VCU
    {
       ...
       public static bool ems_wake_up_u1 => Convert.ToBoolean((wake_up_u8 >> 3 & 0b00000001));
       public static bool system_on_off_u1 => Convert.ToBoolean((wake_up_u8 >> 4 & 0b00000001));
       ...
       public static bool Vcu_ignition_u1 => Convert.ToBoolean((drive_commands_u8 >> 2 & 0b00000001));
        ...
        public static bool ems_can_control_u1 => Convert.ToBoolean((can_error_u8 >> 3 & 0b00000001));

        public static string log_datas => wake_up_u8.ToString() + '$' +
                                          set_velocity_u8.ToString() + '$' + can_error_u8.ToString() + '$';
    }
}
