...
namespace telemetry_hydro.Variables
{
    public class Logs
    {
        ...
        public void ReadArayüz(string []old_datass)
        {
            ...
            Driver.phase_a_rms_f32 = float.Parse(old_datass[count++]);
            ...
            EMS.out_cons_f32 = float.Parse(old_datass[count++]);
        ...
        public void readSdCard(string[] old_datass)
        {
           ...
           // GpsTracker.gps_efficiency_u8 = byte.Parse(old_datass[count++]);
            ...
            EMS.fc_volt_f32 = float.Parse(old_datass[count++].Replace('.', ','));
            EMS.error_u8 = byte.Parse(old_datass[count++]);
            EMS.out_cons_f32 = float.Parse(old_datass[count++].Replace('.', ','));
