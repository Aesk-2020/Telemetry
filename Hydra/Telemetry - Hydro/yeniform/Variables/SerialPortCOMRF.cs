...
namespace telemetry_hydro.Variables
{
    ...
    public class SerialPortCOMRF
    {
        ...
        private void dataConvert(byte[] receiveBuffer)
        {
            ...
            EMS.bat_cons_f32 = (float)EncodePackMethods.DataConverterU16(receiveBuffer, ref startIndex) / MACROS.FLOAT_CONVERTER_1;
            EMS.fc_cons_f32 = (float)EncodePackMethods.DataConverterU16(receiveBuffer, ref startIndex) / MACROS.FLOAT_CONVERTER_1;
            EMS.fc_lt_cons_f32 = (float)EncodePackMethods.DataConverterU16(receiveBuffer, ref startIndex) / MACROS.FLOAT_CONVERTER_1;
            EMS.out_cons_f32 = (float)EncodePackMethods.DataConverterU16(receiveBuffer, ref startIndex) / MACROS.FLOAT_CONVERTER_1;
                    ...
                    case receiveDataStates.AddBuffer:
                        {
                            ...
                            if (data_counter >= _receiveDataBufferLength)
                            {
                                ...
                                GL_rf_efficiency_f32 = (int)(((GL_cozulen_paket_u32 * _receiveDataBufferLength) / (GL_gelen_bayt_u32)) * MACROS.FLOAT_CONVERTER_2);
                                state = receiveDataStates.CatchHeader;
                            }
                            break;
                        }
