                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            Column(
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: <Widget>[
                                myText(AeskData.bms_bat_volt_f32.toString(), 25, Theme.of(context).textTheme.headline1.color, FontWeight.bold),
                                myText("Gerilim", 15, Theme.of(context).textTheme.headline1.color, FontWeight.bold),
                                SizedBox(height: 5,),
                                myText(AeskData.bms_temp_u8.toString(), 25, Theme.of(context).textTheme.headline1.color, FontWeight.bold),
                                myText("Sıcaklık", 15, Theme.of(context).textTheme.headline1.color, FontWeight.bold),
                                SizedBox(height: 5,),
                                myText(AeskData.bms_bat_current_f32.toString(), 25, Theme.of(context).textTheme.headline1.color, FontWeight.bold),
                                myText("Akım", 15, Theme.of(context).textTheme.headline1.color, FontWeight.bold),
                                SizedBox(height: 5,),
                                myText(AeskData.bms_power_f32.toString(), 25, Theme.of(context).textTheme.headline1.color, FontWeight.bold),
                                myText("Güç", 15, Theme.of(context).textTheme.headline1.color, FontWeight.bold),
                                SizedBox(height: 5,),
                                myText(AeskData.bms_soc_f32.toString(), 25, Theme.of(context).textTheme.headline1.color, FontWeight.bold),
                                myText("SoC Gerilimi", 15, Theme.of(context).textTheme.headline1.color, FontWeight.bold),
                                SizedBox(height: 5,),
                                myText(AeskData.bms_bat_cons_f32.toString(), 25, Theme.of(context).textTheme.headline1.color, FontWeight.bold),
                                myText("Tüketim", 15, Theme.of(context).textTheme.headline1.color, FontWeight.bold),
                                SizedBox(height: 5,),
                                myText(AeskData.bms_worst_cell_voltage_f32.toString(), 25, Theme.of(context).textTheme.headline1.color, FontWeight.bold),
                                myText("Worst Cell Gerilimi", 15, Theme.of(context).textTheme.headline1.color, FontWeight.bold),
                                SizedBox(height: 5,),
                                myText(AeskData.bms_worst_cell_address_u8.toString(), 25, Theme.of(context).textTheme.headline1.color, FontWeight.bold),
                                myText("Worst Cell Adresi", 15, Theme.of(context).textTheme.headline1.color, FontWeight.bold),
