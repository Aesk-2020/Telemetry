                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: <Widget>[
                          CellWidget("Cell-17", AeskData.battery_cells[16].toString(), context, AeskData.bms_min_finder == 16 ? Colors.red[500] : Theme.of(context).textTheme.headline1.color),
                          CellWidget("Cell-18", AeskData.battery_cells[17].toString(), context, AeskData.bms_min_finder == 17 ? Colors.red[500] : Theme.of(context).textTheme.headline1.color),
                          CellWidget("Cell-19", AeskData.battery_cells[18].toString(), context, AeskData.bms_min_finder == 18 ? Colors.red[500] : Theme.of(context).textTheme.headline1.color),
                          CellWidget("Cell-20", AeskData.battery_cells[19].toString(), context, AeskData.bms_min_finder == 19 ? Colors.red[500] : Theme.of(context).textTheme.headline1.color),
                        ],
                      ),
                      SizedBox(height: 20,),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: <Widget>[
                          CellWidget("Cell-21", AeskData.battery_cells[20].toString(), context, AeskData.bms_min_finder == 20 ? Colors.red[500] : Theme.of(context).textTheme.headline1.color),
                          CellWidget("Cell-22", AeskData.battery_cells[21].toString(), context, AeskData.bms_min_finder == 21 ? Colors.red[500] : Theme.of(context).textTheme.headline1.color),
                          CellWidget("Cell-23", AeskData.battery_cells[22].toString(), context, AeskData.bms_min_finder == 22 ? Colors.red[500] : Theme.of(context).textTheme.headline1.color),
                          CellWidget("Cell-24", AeskData.battery_cells[23].toString(), context, AeskData.bms_min_finder == 23 ? Colors.red[500] : Theme.of(context).textTheme.headline1.color),
                        ],
                      ),
                      SizedBox(height: 20,),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: <Widget>[
                          CellWidget("Cell-25", AeskData.battery_cells[24].toString(), context, AeskData.bms_min_finder == 24 ? Colors.red[500] : Theme.of(context).textTheme.headline1.color),
                          CellWidget("Cell-26", AeskData.battery_cells[25].toString(), context, AeskData.bms_min_finder == 25 ? Colors.red[500] : Theme.of(context).textTheme.headline1.color),
                          CellWidget("Cell-27", AeskData.battery_cells[26].toString(), context, AeskData.bms_min_finder == 26 ? Colors.red[500] : Theme.of(context).textTheme.headline1.color),
                          CellWidget("Cell-28", AeskData.battery_cells[27].toString(), context, AeskData.bms_min_finder == 27 ? Colors.red[500] : Theme.of(context).textTheme.headline1.color),
                        ],
                      ),
                      SizedBox(height: 20,),
                      Row(
