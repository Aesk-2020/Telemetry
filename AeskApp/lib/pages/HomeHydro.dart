                    ...
                    children: <Widget>[
                      Column(
                        ...
                        children: <Widget>[
                          ...
                          DataBox(
                            ad: "EYS BAT VOLT",
                            veri: AeskData.eys_bat_volt_uint16.toStringAsFixed(2),
                          ),
                          DataBox(
                            ad: "EYS BAT CUR",
                            veri: AeskData.eys_bat_current_int16.toStringAsFixed(2),
                          ),
                          DataBox(
                            ad: "EYS BAT CONS",
                            veri: AeskData.eys_bat_cons_uint16.toStringAsFixed(2),
                          ),
                          DataBox(
                            ad: "EYS SOC",
                            veri: AeskData.eys_bat_soc_uint16.toStringAsFixed(2),
                          ),
                          DataBox(
                            ad: "EYS EYS OUT VOLT",
                            veri: AeskData.eys_out_volt_uint16.toStringAsFixed(2),
                          ),
                          DataBox(
                            ad: "EYS TEMP",
                            veri: AeskData.eys_temp_uint8.toStringAsFixed(2),
                          ),
                        ],
                      ),
                      Column(
                        children: <Widget>[
                          ...
                          DataBox(
                            ad: "EYS FC VOLT",
                            veri:
                            AeskData.eys_fc_volt_uint16.toStringAsFixed(2),
                          ),
                          DataBox(
                            ad: "EYS OUT CONS",
                            veri:
                            AeskData.eys_out_cons_uint16.toStringAsFixed(2),
                          ),
                          DataBox(
                            ad: "EYS OUT CUR",
                            veri: AeskData.eys_out_current_int16.toStringAsFixed(2),
                          ),
                          DataBox(
                            ad: "EYS PENALTY",
                            veri: AeskData.eys_penalty_int8.toStringAsFixed(2),
                          ),
                          DataBox(
                            ad: "EYS SHARING RATIO",
                            veri: AeskData.eys_sharing_ratio.toStringAsFixed(2),
                          ),
                        ],
                      ),
                    ],
