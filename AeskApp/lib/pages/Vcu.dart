              ...
              Card(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(height: 15,),
                    Center(
                      child: Text("MCU_L Akım ve Gerilim Seviyeleri",
                        style: TextStyle(
                    ...
                    SizedBox(height: 15,),
                    Center(
                      child: Text("MCU_R Akım ve Gerilim Seviyeleri",
                        style: TextStyle(
                          color: Theme.of(context).textTheme.headline1.color,
                          fontWeight: FontWeight.bold,
                          fontSize: scale.size.width/20.571428,
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Container(
                            margin: EdgeInsets.all(scale.size.width/41.142857),
                            child: Text("Act ID:" + " " + AeskData.driver_act_id_u16_2.toStringAsFixed(2),style: TextStyle(fontWeight: FontWeight.bold,fontSize: scale.size.width/20.571428,color: Theme.of(context).textTheme.headline1.color,fontFamily: "GOTHIC",),textAlign: TextAlign.start,),),
                          Container(
                            margin: EdgeInsets.all(scale.size.width/41.142857),
                            alignment: Alignment.center,
                            child: Text("Act IQ:" + " " + AeskData.driver_act_iq_u16_2.toStringAsFixed(2), style: TextStyle(fontWeight: FontWeight.bold,fontSize: scale.size.width/20.571428,color: Theme.of(context).textTheme.headline1.color,fontFamily: "GOTHIC",),textAlign: TextAlign.center,),),
                        ],
                      ),
                    ),
                    Container(
                    ...
                    SizedBox(height: 15,),
                    myText("     MCU_L Diğer Veriler", 20, Theme.of(context).textTheme.headline1.color, FontWeight.bold),
                    Divider(thickness: 4,color: Theme.of(context).textTheme.headline3.color,endIndent: 25,indent: 25,),
                    Container(
                      child: myText(
                    ...
                    SizedBox(height: 15,),
                    myText("     MCU_R Diğer Veriler", 20, Theme.of(context).textTheme.headline1.color, FontWeight.bold),
                    Divider(thickness: 4,color: Theme.of(context).textTheme.headline3.color,endIndent: 25,indent: 25,),
                    Container(
                      child: myText(
                          "Motor Sıcaklığı : " +AeskData.driver_motortemp_u8_2.toString()+ " °C",
                          scale.size.width/20.571428,
                          Theme.of(context).textTheme.headline1.color,
                          FontWeight.bold),
                      alignment: Alignment.center,
                    ...
                    Container(
                      child: myText(
                          "Anlık Hız : "+AeskData.driver_actspeed_s16_2.toStringAsFixed(2)+" km/h",
                          scale.size.width/20.571428,
                          Theme.of(context).textTheme.headline1.color,
                          FontWeight.bold),
                      alignment: Alignment.center,
                    ...
                    Container(
                      child: myText(
                          "Set Torque : "+AeskData.vcu_set_torque_2_s16.toString() + " N*m",
                          scale.size.width/20.571428,
                          Theme.of(context).textTheme.headline1.color,
                          FontWeight.bold),
                      alignment: Alignment.center,
                    ...
                    SizedBox(height: 15,),
                    myText("     MCU_L Hatalar", scale.size.width/20.571428, Theme.of(context).textTheme.headline1.color, FontWeight.bold),
                    Divider(thickness: 4,color: Theme.of(context).textTheme.headline3.color,endIndent: 25,indent: 25,),
                    Column(
                      children: <Widget>[
                        ...
                        child: Row(
                          ...
                          children: [
                            ElevatedButton.icon(
                              ...
                              label: myText("Reset TCU", 12, Theme.of(context).textTheme.headline2.color, FontWeight.bold),
                              onPressed: () async {
                                final builder = mqtt.MqttClientPayloadBuilder();
                                builder.addByte(0x14); //SYNC1
                                builder.addByte(0x04); //SYNC2
                            ...
                            ElevatedButton.icon(
                              ...
                              label: myText("Set RTC TCU", 12, Theme.of(context).textTheme.headline2.color, FontWeight.bold),
                              onPressed: () async {
                                final builder = mqtt.MqttClientPayloadBuilder();
                                builder.addByte(0x14); //SYNC1
                                builder.addByte(0x04); //SYNC2
