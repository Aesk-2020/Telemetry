            ...
            leading: myText("AeskApp", 25, Theme.of(context).textSelectionColor, FontWeight.bold),
              ...
              + drawerList.map((element) {
                return ListTile(
                  ...
                  onTap: () => (ModalRoute.of(context).settings.name == "/Home" || ModalRoute.of(context).settings.name == "/HomeHydro") ? Navigator.popAndPushNamed(context, element.destination) : Navigator.pushReplacementNamed(context, element.destination),
