...
namespace yeniform.Variables
{
    public struct SectorAndTourDatas
    {
        ...
        public static uint sector_3_ortalama_hiz_vcu => (uint)((double)(gidilen_yol_vcu_sector_3_u32 / sector1_sure.Elapsed.TotalSeconds) * MACROS.mstokmh);
        public static uint sector_4_ortalama_hiz_vcu => (uint)((double)(gidilen_yol_vcu_sector_4_u32 / sector2_sure.Elapsed.TotalSeconds) * MACROS.mstokmh);
