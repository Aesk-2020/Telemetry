...
namespace yeniform.Variables
{
    public struct SectorAndTourDatas
    {
        ...
        public static object[] turAtDatas => new object[8] {Timers.currentTour, "ST", Timers.Anlik_tur_süresi.Elapsed.ToString(MACROS.TimeStringFormat), SectorAndTourDatas.gidilen_yol_vcu_sector_T_u32,
                                   SectorAndTourDatas.gidilen_yol_gps_sector_T_u32, SectorAndTourDatas.sector_T_ortalama_hiz_vcu, SectorAndTourDatas.sector_T_ortalama_hiz_gps, 0} ;
        public static object[] sector1Datas => new object[8] {Timers.currentTour, "S1", SectorAndTourDatas.sector1_sure.Elapsed.ToString(MACROS.TimeStringFormat),
                                           SectorAndTourDatas.gidilen_yol_vcu_sector_1_u32, SectorAndTourDatas.gidilen_yol_gps_sector_1_u32,
                                           SectorAndTourDatas.sector_1_ortalama_hiz_vcu, SectorAndTourDatas.sector_1_ortalama_hiz_gps, 0};
        public static object[] sector2Datas => new object[8] {Timers.currentTour, "S2", SectorAndTourDatas.sector2_sure.Elapsed.ToString(MACROS.TimeStringFormat),
                                           SectorAndTourDatas.gidilen_yol_vcu_sector_2_u32, SectorAndTourDatas.gidilen_yol_gps_sector_2_u32,
                                           SectorAndTourDatas.sector_2_ortalama_hiz_vcu, SectorAndTourDatas.sector_2_ortalama_hiz_gps, 0};
