...
namespace yeniform
{
    public partial class telemetry : Form
    {
        ...
        void displayAllData()
        {
            ...
            ThreadMethods.TextDegis(driver_fwrv_command, VCU.Vcu_direction_u1 ? "REVERSE" : "FORWARD");
            ThreadMethods.TextDegis(driver_brake_command,VCU.Vcu_brake_u1 ? "BRAKE ON" : "BRAKE OFF");
            ThreadMethods.TextDegis(driver_ign_command,VCU.Vcu_ignition_u1 ? "IGN ON" : "IGN OFF");
        ...
        private void gMapControl1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                double angle = myGmap.addGMapCalcAngleCalcOdometer(mouse_position.Lat, mouse_position.Lng);
        ...
        private void başlatToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            SectorAndTourDatas.gidilen_yol_vcu_sector_T_u32 = myGmap.odometer_gps;
        ...
        private void history_displayer_ValueChanged(object sender, EventArgs e)
        {
            ...
            if(mylogs.history_counter > history_displayer.Value)
            {
                ...
                {
                    mylogs.hold_history_shower = mylogs.history_counter + 1;
