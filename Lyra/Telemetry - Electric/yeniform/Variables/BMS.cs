...
namespace Telemetri.Variables
{
    public class BMS
    {
        ...
        public static byte temp1_u8;
        public static byte temp2_u8;
        public static byte temp3_u8;
        public static byte temp4_u8;
        public static byte temp5_u8;
        public static byte temp6_u8;
        public static byte temp7_u8; 
        public static float[] bms_cells = new float[84];
        public static float[] bms_soc = new float[84];
        ...
        public static bool charging_u1 => Convert.ToBoolean(dc_bus_state_u8 >> 3 & 0b00000001);
        ...
        public static string log_data_bms => bat_volt_f32.ToString("0.0") + '\t' + bat_current_f32.ToString("0.00") + '\t' + bat_cons_f32.ToString("0.0")
                                              + '\t' + soc_f32.ToString("0.00") + '\t' + bms_error_u8.ToString() + '\t' + dc_bus_state_u8.ToString()
                                              + '\t' + worst_cell_voltage_f32.ToString("0.0") + '\t' + worst_cell_address_u8.ToString()
                                              + '\t' + temp_u8.ToString() + '\t';
